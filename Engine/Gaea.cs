...
public class Gaea(Grid grid, Rules rules, Action<int, Generation, double> update, Generation cells)
{
    ...
    public Action<int, Generation, double> UpdateVisualization { get; } = update;
